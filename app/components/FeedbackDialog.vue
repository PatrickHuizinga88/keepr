  ...
  <Dialog>
    <DialogTrigger as-child>
      <Button
        variant="ghost"
        size="sm"
        class="w-full justify-start font-normal hover:bg-foreground/5 p-2"
      >
    ...
    <DialogContent class="max-w-xl">
      ...
      <DialogFooter>
        ...
        <Button v-if="!success" :loading="loading" form="feedback-form">{{
          $t("common.actions.send_item", { item: $t("feedback.feedback") })
        }}</Button>
      </DialogFooter>
    </DialogContent>
  </Dialog>
