  ...
  <div class="container">
      ...
      <div class="grid sm:grid-cols-2 gap-6">
        ...
        <div class="space-y-3">
          <Dialog>
            ...
            <DialogContent
              class="grid-rows-[auto_minmax(0,1fr)_auto] max-h-[90dvh] sm:max-w-3xl p-0"
            >
    ...
    <section id="danger-zone">
      ...
      <p class="text-muted-foreground text-sm mb-6">
        {{ $t("account.danger_zone.explanation") }}
        <a :href="`mailto:${supportEmail}`" class="text-primary-dark underline">{{
          supportEmail
        }}</a
        >.
      </p>
